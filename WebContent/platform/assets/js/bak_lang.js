...
function addSubjectIdIntoUrl(){
	var aUrl = $(".selected a").attr("href");
    if(aUrl!=null && aUrl!=undefined){
    	subjectId = aUrl.split(".")[0];
    	aUrl = aUrl.replace("#",subjectId);
    }
    $(".selected a").attr("href",aUrl);
